...
PROTO UINT32 MOTOR_COUNT_Obj6000
#ifdef _EVALBOARD_
 = 0
#endif
;
		
PROTO INT16 MOTOR_MESSAGE_Obj6010
#ifdef _EVALBOARD_
 = 0
#endif
;
		
PROTO INT16 ERROR_MSG_Obj6020
#ifdef _EVALBOARD_
 = 0
#endif
;
		
PROTO INT16 MACHINE_PARAM_Obj6030
#ifdef _EVALBOARD_
 = 0
#endif
;

PROTO INT16 LIMIT_STATE_Obj6040
#ifdef _EVALBOARD_
 = 0
#endif
;

PROTO INT16 AD_CH1_Obj6050
#ifdef _EVALBOARD_
 = 0
#endif
;
		
PROTO INT16 AD_CH2_Obj6060
#ifdef _EVALBOARD_
 = 0
#endif
;

PROTO INT16 AD_CH3_Obj6070
#ifdef _EVALBOARD_
 = 0
#endif
;

PROTO UINT16 IO_OUTPUT_Obj7000
#ifdef _EVALBOARD_
 = 0
#endif
;

PROTO UINT16 STEP_SETTING_Obj7010
#ifdef _EVALBOARD_
 = 0
#endif
;
		
PROTO UINT16 STEP_FRE_Obj7020
#ifdef _EVALBOARD_
 = 0
#endif
;

PROTO UINT16 MOTOR_DIR_Obj7030
#ifdef _EVALBOARD_
 = 0
#endif
;
		
PROTO UINT32 MOTOR1_STEP_Obj7040
#ifdef _EVALBOARD_
 = 0
#endif
;

PROTO UINT32 MOTOR2_STEP_Obj7050
#ifdef _EVALBOARD_
 = 0
#endif
;
		
PROTO UINT32 MOTOR3_STEP_Obj7060
#ifdef _EVALBOARD_
 = 0
#endif
;

PROTO UINT32 MOTOR4_STEP_Obj7070
#ifdef _EVALBOARD_
 = 0
#endif
;
		
PROTO UINT32 MOTOR5_STEP_Obj7080
#ifdef _EVALBOARD_
 = 0
#endif
;

PROTO UINT32 MOTOR6_STEP_Obj7090
#ifdef _EVALBOARD_
 = 0
#endif
;

PROTO UINT32 MOTOR7_STEP_Obj70a0
#ifdef _EVALBOARD_
 = 0
#endif
;
...
#ifdef _EVALBOARD_
 = {11, {0x70000010, 0x70100010, 0x70200010, 0x70300010,0x70400020, 0x70500020, 0x70600020, 0x70700020,0x70800020, 0x70900020,0x70a00020}} //equal to 1600 Entry
#endif
 ;
...
#ifdef _EVALBOARD_
 = {8, {0x60000020, 0x60100010, 0x60200010, 0x60300010,0x60400010, 0x60500010,0x60600010,0x60700010}} //equal to 1A00 Entry
#endif
;
...
OBJCONST TSDOINFOENTRYDESC    OBJMEM asEntryDesc0x6000 = {DEFTYPE_UNSIGNED32, 0x20, ACCESS_READ | OBJACCESS_TXPDOMAPPING }; 
OBJCONST UCHAR OBJMEM aName0x6000[] = "MOTOR_COUNT";

OBJCONST TSDOINFOENTRYDESC    OBJMEM asEntryDesc0x6010 = {DEFTYPE_INTEGER16, 0x10, ACCESS_READ | OBJACCESS_TXPDOMAPPING }; 
OBJCONST UCHAR OBJMEM aName0x6010[] = "MOTOR_MESSAGE";

OBJCONST TSDOINFOENTRYDESC    OBJMEM asEntryDesc0x6020 = {DEFTYPE_INTEGER16, 0x10, ACCESS_READ | OBJACCESS_TXPDOMAPPING }; 
OBJCONST UCHAR OBJMEM aName0x6020[] = "ERROR_MSG";

OBJCONST TSDOINFOENTRYDESC    OBJMEM asEntryDesc0x6030 = {DEFTYPE_INTEGER16, 0x10, ACCESS_READ | OBJACCESS_TXPDOMAPPING }; 
OBJCONST UCHAR OBJMEM aName0x6030[] = "MACHINE_PARAM";

OBJCONST TSDOINFOENTRYDESC    OBJMEM asEntryDesc0x6040 = {DEFTYPE_INTEGER16, 0x10, ACCESS_READ | OBJACCESS_TXPDOMAPPING }; 
OBJCONST UCHAR OBJMEM aName0x6040[] = "LIMIT_STATE";

OBJCONST TSDOINFOENTRYDESC    OBJMEM asEntryDesc0x6050 = {DEFTYPE_INTEGER16, 0x10, ACCESS_READ | OBJACCESS_TXPDOMAPPING }; 
OBJCONST UCHAR OBJMEM aName0x6050[] = "AI_CH1";

OBJCONST TSDOINFOENTRYDESC    OBJMEM asEntryDesc0x6060 = {DEFTYPE_INTEGER16, 0x10, ACCESS_READ | OBJACCESS_TXPDOMAPPING }; 
OBJCONST UCHAR OBJMEM aName0x6060[] = "AI_CH2";

OBJCONST TSDOINFOENTRYDESC    OBJMEM asEntryDesc0x6070 = {DEFTYPE_INTEGER16, 0x10, ACCESS_READ | OBJACCESS_TXPDOMAPPING }; 
OBJCONST UCHAR OBJMEM aName0x6070[] = "AI_CH3";


OBJCONST TSDOINFOENTRYDESC    OBJMEM asEntryDesc0x7000 = {DEFTYPE_UNSIGNED16, 0x10, ACCESS_READ | OBJACCESS_RXPDOMAPPING }; 
OBJCONST UCHAR OBJMEM aName0x7000[] = "IO_OUTPUT";

OBJCONST TSDOINFOENTRYDESC    OBJMEM asEntryDesc0x7010 = {DEFTYPE_UNSIGNED16, 0x10, ACCESS_READ | OBJACCESS_RXPDOMAPPING }; 
OBJCONST UCHAR OBJMEM aName0x7010[] = "STEP_SETTING";


OBJCONST TSDOINFOENTRYDESC    OBJMEM asEntryDesc0x7020 = {DEFTYPE_UNSIGNED16, 0x10, ACCESS_READ | OBJACCESS_RXPDOMAPPING }; 
OBJCONST UCHAR OBJMEM aName0x7020[] = "STEP_FRE";


OBJCONST TSDOINFOENTRYDESC    OBJMEM asEntryDesc0x7030 = {DEFTYPE_UNSIGNED16, 0x10, ACCESS_READ | OBJACCESS_RXPDOMAPPING }; 
OBJCONST UCHAR OBJMEM aName0x7030[] = "MOTOR_DIR";


OBJCONST TSDOINFOENTRYDESC    OBJMEM asEntryDesc0x7040 = {DEFTYPE_UNSIGNED32, 0x20, ACCESS_READ | OBJACCESS_RXPDOMAPPING }; 
OBJCONST UCHAR OBJMEM aName0x7040[] = "MOTOR1_STEP";

OBJCONST TSDOINFOENTRYDESC    OBJMEM asEntryDesc0x7050 = {DEFTYPE_UNSIGNED32, 0x20, ACCESS_READ | OBJACCESS_RXPDOMAPPING }; 
OBJCONST UCHAR OBJMEM aName0x7050[] = "MOTOR2_STEP";

OBJCONST TSDOINFOENTRYDESC    OBJMEM asEntryDesc0x7060 = {DEFTYPE_UNSIGNED32, 0x20, ACCESS_READ | OBJACCESS_RXPDOMAPPING }; 
OBJCONST UCHAR OBJMEM aName0x7060[] = "MOTOR3_STEP";

OBJCONST TSDOINFOENTRYDESC    OBJMEM asEntryDesc0x7070 = {DEFTYPE_UNSIGNED32, 0x20, ACCESS_READ | OBJACCESS_RXPDOMAPPING }; 
OBJCONST UCHAR OBJMEM aName0x7070[] = "MOTOR4_STEP";

OBJCONST TSDOINFOENTRYDESC    OBJMEM asEntryDesc0x7080 = {DEFTYPE_UNSIGNED32, 0x20, ACCESS_READ | OBJACCESS_RXPDOMAPPING }; 
OBJCONST UCHAR OBJMEM aName0x7080[] = "MOTOR5_STEP";

OBJCONST TSDOINFOENTRYDESC    OBJMEM asEntryDesc0x7090 = {DEFTYPE_UNSIGNED32, 0x20, ACCESS_READ | OBJACCESS_RXPDOMAPPING }; 
OBJCONST UCHAR OBJMEM aName0x7090[] = "MOTOR6_STEP";

OBJCONST TSDOINFOENTRYDESC    OBJMEM asEntryDesc0x70a0 = {DEFTYPE_UNSIGNED32, 0x20, ACCESS_READ | OBJACCESS_RXPDOMAPPING }; 
OBJCONST UCHAR OBJMEM aName0x70a0[] = "MOTOR7_STEP";
...
TOBJECT    OBJMEM ApplicationObjDic[] = {
   ...
   /* Object 0x1601 */
   {NULL,NULL,  0x1600, {DEFTYPE_PDOMAPPING, 11 | (OBJCODE_REC << 8)}, asEntryDesc0x1600, aName0x1600, &sDORxPDOMap, NULL, NULL, 0x0000 },//与定义的PDO的输入输出变量相同,少了有问题，多了有警告
   /* Object 0x1A00 */
   {NULL,NULL,   0x1A00, {DEFTYPE_PDOMAPPING, 8 | (OBJCODE_REC << 8)}, asEntryDesc0x1A00, aName0x1A00, &sDITxPDOMap, NULL, NULL, 0x0000 },
   /* Object 0x1A02 */
    /* Object 0x1C12 */
   ...
   {NULL,NULL,   0x1C13, {DEFTYPE_UNSIGNED16, 1 | (OBJCODE_ARR << 8)}, asPDOAssignEntryDesc, aName0x1C13, &sTxPDOassign, NULL, NULL, 0x0000 },
	 ...
	 /* Object 0x60X0 */
	 {NULL,NULL,   0x6000, {DEFTYPE_UNSIGNED32, 0 | (OBJCODE_VAR << 8)}, &asEntryDesc0x6000, aName0x6000, &MOTOR_COUNT_Obj6000, NULL, NULL, 0x0000 },
   {NULL,NULL,   0x6010, {DEFTYPE_INTEGER16,  0 | (OBJCODE_VAR << 8)}, &asEntryDesc0x6010, aName0x6010, &MOTOR_MESSAGE_Obj6010, NULL, NULL, 0x0000 },
	 {NULL,NULL,   0x6020, {DEFTYPE_INTEGER16,  0 | (OBJCODE_VAR << 8)}, &asEntryDesc0x6020, aName0x6020, &ERROR_MSG_Obj6020, NULL, NULL, 0x0000 },
	 {NULL,NULL,   0x6030, {DEFTYPE_INTEGER16,  0 | (OBJCODE_VAR << 8)}, &asEntryDesc0x6030, aName0x6030, &MACHINE_PARAM_Obj6030, NULL, NULL, 0x0000 },
	 {NULL,NULL,   0x6040, {DEFTYPE_INTEGER16,  0 | (OBJCODE_VAR << 8)}, &asEntryDesc0x6040, aName0x6040, &LIMIT_STATE_Obj6040, NULL, NULL, 0x0000 },
	 {NULL,NULL,   0x6050, {DEFTYPE_INTEGER16,  0 | (OBJCODE_VAR << 8)}, &asEntryDesc0x6050, aName0x6050, &AD_CH1_Obj6050, NULL, NULL, 0x0000 },
	 {NULL,NULL,   0x6060, {DEFTYPE_INTEGER16,  0 | (OBJCODE_VAR << 8)}, &asEntryDesc0x6060, aName0x6060, &AD_CH2_Obj6060, NULL, NULL, 0x0000 },
	 {NULL,NULL,   0x6070, {DEFTYPE_INTEGER16,  0 | (OBJCODE_VAR << 8)}, &asEntryDesc0x6070, aName0x6070, &AD_CH3_Obj6070, NULL, NULL, 0x0000 },
	 
    /* Object 0x70X0 */
	 {NULL,NULL,   0x7000, {DEFTYPE_UNSIGNED16, 0 | (OBJCODE_VAR << 8)}, &asEntryDesc0x7000, aName0x7000, &IO_OUTPUT_Obj7000, NULL, NULL, 0x0000 },
   {NULL,NULL,   0x7010, {DEFTYPE_UNSIGNED16, 0 | (OBJCODE_VAR << 8)}, &asEntryDesc0x7010, aName0x7010, &STEP_SETTING_Obj7010, NULL, NULL, 0x0000 },
	 {NULL,NULL,   0x7020, {DEFTYPE_UNSIGNED16, 0 | (OBJCODE_VAR << 8)}, &asEntryDesc0x7020, aName0x7020, &STEP_FRE_Obj7020, NULL, NULL, 0x0000 },
	 
	 {NULL,NULL,   0x7030, {DEFTYPE_UNSIGNED16, 0 | (OBJCODE_VAR << 8)}, &asEntryDesc0x7030, aName0x7030, &MOTOR_DIR_Obj7030, NULL, NULL, 0x0000 },
	 {NULL,NULL,   0x7040, {DEFTYPE_UNSIGNED32, 0 | (OBJCODE_VAR << 8)}, &asEntryDesc0x7040, aName0x7040, &MOTOR1_STEP_Obj7040, NULL, NULL, 0x0000 },
   {NULL,NULL,   0x7050, {DEFTYPE_UNSIGNED32, 0 | (OBJCODE_VAR << 8)}, &asEntryDesc0x7050, aName0x7050, &MOTOR2_STEP_Obj7050, NULL, NULL, 0x0000 },
	 {NULL,NULL,   0x7060, {DEFTYPE_UNSIGNED32, 0 | (OBJCODE_VAR << 8)}, &asEntryDesc0x7060, aName0x7060, &MOTOR3_STEP_Obj7060, NULL, NULL, 0x0000 },
	 {NULL,NULL,   0x7070, {DEFTYPE_UNSIGNED32, 0 | (OBJCODE_VAR << 8)}, &asEntryDesc0x7070, aName0x7070, &MOTOR4_STEP_Obj7070, NULL, NULL, 0x0000 },
	 {NULL,NULL,   0x7080, {DEFTYPE_UNSIGNED32, 0 | (OBJCODE_VAR << 8)}, &asEntryDesc0x7080, aName0x7080, &MOTOR5_STEP_Obj7080, NULL, NULL, 0x0000 },  
	 {NULL,NULL,   0x7090, {DEFTYPE_UNSIGNED32, 0 | (OBJCODE_VAR << 8)}, &asEntryDesc0x7090, aName0x7090, &MOTOR6_STEP_Obj7090, NULL, NULL, 0x0000 },
	 {NULL,NULL,   0x70a0, {DEFTYPE_UNSIGNED32, 0 | (OBJCODE_VAR << 8)}, &asEntryDesc0x70a0, aName0x70a0, &MOTOR7_STEP_Obj70a0, NULL, NULL, 0x0000 },  
    /* Object 0xF000 */
